<template>
  ...
  class="my-icon">
    ...
    <template v-else-if="icon === 'loader'">
      <svg class="spinner" viewBox="0 0 50 50" width="50px" height="50px">
    ...
    <template v-else-if="icon === 'more-vert'">
    ...
    <template v-else-if="icon === 'arrow-down'">
      <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
    ...
    <template v-else-if="icon === 'eye'">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18px" fill="var(--blue-gray-high)">
        <path d="M0 0h24v24H0z" fill="none"/>
    ...
    <template v-else-if="icon === 'arrow-down-right'">
      <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24" width="24" height="24" fill="#000000">
    ...
    <template v-else-if="icon === 'double-arrow'">
      <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
