<template>
  <div class="__chekt-select-search-with-input-wrapper">
    <div class="__chekt-select-search-with-input-text">
      <div class="__chekt-select-search-with-input-currency">{{selectValue}}</div>
      <input type="text" placeholder="0.00">
    </div>
    <div id="__chekt-select-search" style="width:80px; border-radius: 0px 4px 4px 0px;" @click="openSelectSearchModal($event)">
